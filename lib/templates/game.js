...
Game.prototype.attachEvents = function attachEvents(app) {
  ...
  $("#controls").on("mouseenter", function () {
    $('#controls').toggleClass("controls-expanded");
  });
  ...
  function darker() {
    hudopacity = hudopacity / 1.25;
    $("#hud").css("opacity", hudopacity);
  }

  function lighter() {
    hudopacity = hudopacity / 0.90;
    $("#hud").css("opacity", hudopacity);
  }
  ...
  $('#game_help').on('click', function () {
    let user_message = `
               <div id="controls-content" class="controls-content">
                 <div><span id="zoomup" title="Board - Zoom In" class="fa fa-plus-circle zoombutton zoomup hud-button"></span><span>Zoom In</span></div>
                 <div><span id="zoomdown" title="Board - Zoom Out" class="fa fa-minus-circle zoombutton zoomdown hud-button"></span><span>Zoom Out</span></div>          
                 <div><span id="pin" title="Allow or Lock Auto-expand" class="fa fa-arrows-v hud-button"></span><span>Lock Controls</span></div>
              </div>
               `;
