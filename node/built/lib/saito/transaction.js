...
exports.HOP_SIZE = exports.SLIP_SIZE = exports.TRANSACTION_SIZE = void 0;
...
const transaction_2 = __importDefault(require("saito-js/lib/transaction"));
exports.TRANSACTION_SIZE = 93;
exports.SLIP_SIZE = 67;
exports.HOP_SIZE = 130;
class Transaction extends transaction_2.default {
    // public path: Array<Hop>;
    constructor(data, jsonobj = null) {
        super(data);
        /////////////////////////
        // consensus variables //
        /////////////////////////
    ...
    async generateRebroadcastTransaction(app, output_slip_to_rebroadcast, with_fee, with_staking_subsidy) {
        ...
        transaction.type = transaction_1.TransactionType.ATR;
        const output = new slip_1.default();
        output.publicKey = output_slip_to_rebroadcast.publicKey;
        output.amount = output_payment;
        output.type = slip_2.SlipType.ATR;
        ...
        //
        if (output_slip_to_rebroadcast.type === slip_2.SlipType.ATR) {
    ...
    deserialize_from_web(app, webstring) {
        try {
    ...
    deserialize_from_base64(base64string) {
