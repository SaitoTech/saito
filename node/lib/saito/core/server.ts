  ...
  initialize() {
    ...
    if (this.app.options.server != null) {
      ...
      this.server.sendblks =
        typeof this.app.options.server.sendblks == 'undefined' ? 1 : this.app.options.server.sendblks;
      ...
      this.server.receiveblks =
        typeof this.app.options.server.receiveblks == 'undefined' ? 1 : this.app.options.server.receiveblks;
      this.server.receivetxs =
        typeof this.app.options.server.receivetxs == 'undefined' ? 1 : this.app.options.server.receivetxs;
      this.server.receivegts =
        typeof this.app.options.server.receivegts == 'undefined' ? 1 : this.app.options.server.receivegts;
    }
