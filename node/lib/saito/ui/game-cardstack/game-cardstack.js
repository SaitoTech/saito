...
class GameCardStack {
  ...
  render() {
    ...
    if (this.orientation == 'left' || this.orientation == 'right') {
      ...
      let needed_height = (num_face_down * gap) / 4 + (this.cards.length - num_face_down - 2) * gap + card_height;
      ...
      if (container.height < needed_height) {
        ...
        gap = (container.height - card_height) / (this.cards.length - num_face_down - 1 + num_face_down / 4);
