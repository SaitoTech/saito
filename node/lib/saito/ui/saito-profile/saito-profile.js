...
class SaitoProfile {
  ...
  attachEvents() {
    if (this.tab_container) {
      document.querySelectorAll(`#saito-profile${this.ordinal} .saito-profile-tab`).forEach((el) => {
        el.onclick = (e) => {
    ...
    if (document.querySelector(`#saito-profile${this.ordinal} #saito-banner-edit`)) {
      document.querySelector(`#saito-profile${this.ordinal} #saito-banner-edit`).onclick = async (e) => {
