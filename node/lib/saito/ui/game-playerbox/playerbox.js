...
class GamePlayerBox {
  ...
  updateAddress(address) {
    if (document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .saito-address`)) {
      document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .saito-address`).innerHTML =
        address;
    }
  }
  ...
  updateUserline(userline) {
    if (document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .saito-userline`)) {
      document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .saito-userline`).innerHTML =
        userline;
    }
  }

  updateIcons(content) {
    if (document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .game-playerbox-icons`)) {
      document.querySelector(`.game-playerbox-head-${this.player_number} .saito-user .game-playerbox-icons`).innerHTML =
        content;
    }
  }
