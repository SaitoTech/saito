...
class SaitoCalendar {
  ...
  renderCalendar() {
    ...
    this.state.lastDayIndex = new Date(this.date.getFullYear(), this.date.getMonth() + 1, 0).getDay();
    ...
    // and update HTML
    //
    document.querySelector('.saito-calendar-date .month').innerHTML = this.state.months[this.date.getMonth()];
