  ...
  return `
      <form id="key-entry-template" class="saito-recovery">
        <div class="saito-overlay-form-header">
          <h2 class="saito-overlay-form-header-title">Private Key Recovery</h2>
        </div>
        <div class="saito-overlay-form-text">Enter your private key to login to / restore your Saito account.</div>
        <input type="text" id="private-key-input" class="saito-input saito-overlay-form-email" placeholder="private key" value="" />
