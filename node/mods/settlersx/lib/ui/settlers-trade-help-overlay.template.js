module.exports = (app, mod) => {
  let html = `<div class="rules-overlay saitoa">
              ...
              <p>There are several mechanisms in the game to initiate trades, but two things should be noted. All trades involve the player whose turn it is. Open Chat from the game menu to negotiate with your fellow explorers. This is a social game, and you can do all the wheeling and dealing you want simply by talking to the other players.</p>
              <div class="h2">Open Offers</div>
              <div>
                <p>On your turn, you can initiate a trade offer by selecting <em>Make Offer</em> from the Trade menu. This opens an interface where you can specify how many of which resources you want in exchange for what. Use the arrows above and below each resource count to adjust your offer. </p>
              </div>
              <div>
