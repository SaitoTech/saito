...
class WinterOverlay {
  ...
  render(stage = '') {
    ...
    if (stage == 'stage5' || stage == 'stage6' || stage == 'stage7' || stage == 'stage8') {
      try {
        document.querySelector('.saito-overlay .winter').style.backgroundImage =
          'url(/his/img/backgrounds/diplomacy/ambassadors.jpeg)';
        document.querySelector('.saito-overlay .winter').style.backgroundSize = 'cover';
        document.querySelector('.saito-overlay .winter .winter-title').innerHTML =
          'Diplomacy Phase';
      ...
      document.querySelector('.saito-overlay .winter').style.backgroundImage =
        'url(/his/img/backgrounds/winter_background.jpg)';
      document.querySelector('.saito-overlay .winter').style.backgroundSize = 'cover';
      document.querySelector('.saito-overlay .winter .winter-title').innerHTML =
        'A Passage of Winter';
