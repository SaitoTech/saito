...
class WelcomeOverlay {
  ...
  renderCustom(obj = {}) {
    ...
    if (obj.card) {
      his_self.app.browser.addElementToSelector(
        `<div class="welcome-card">${his_self.returnCardImage(obj.card)}<div>`,
        '.welcome'
      );
    }
    if (obj.styles) {
  ...
  render(faction = '') {
    ...
    if (faction === 'hapsburg_papacy') {
      document.querySelector('.welcome-title').innerHTML = `Hapsburgs and Papacy`;
      document.querySelector('.welcome-text').innerHTML =
        `You are playing as both Hapsburg and Papacy this game.`;
    }
    if (faction === 'france_ottoman') {
      document.querySelector('.welcome-title').innerHTML = `France and Ottoman Empire`;
      document.querySelector('.welcome-text').innerHTML =
        `You are playing as both France and the Ottoman Empire.`;
    }
    if (faction === 'protestant_england') {
      document.querySelector('.welcome-title').innerHTML = `Protestants and England`;
      document.querySelector('.welcome-text').innerHTML =
        `You are playing as both the Protestants and the English.`;
    }
    ...
    // OTTOMAN
    if (faction === 'ottoman') {
      document.querySelector('.welcome-title').innerHTML = `You are the Turks`;
      document.querySelector('.welcome-text').innerHTML = `
    ...
    // ENGLAND
    if (faction === 'england') {
      document.querySelector('.welcome-title').innerHTML = `You are England`;
      document.querySelector('.welcome-text').innerHTML = `
    ...
    // FRANCE
    if (faction === 'france') {
      document.querySelector('.welcome-title').innerHTML = `You are the French`;
      document.querySelector('.welcome-text').innerHTML = `
    ...
    // HAPSBURG
    if (faction === 'hapsburg') {
      document.querySelector('.welcome-title').innerHTML = `You are the Hapsburg Dynasty`;
      document.querySelector('.welcome-text').innerHTML = `
