module.exports = (app, mod) => {
	...
	return `
			...
			<input class="saito-radio" type="radio" id="show" name="overlays" value="1" ${ eo ? 'checked' : ''}/>
			<label for="show">Always show <span class="note">I want to know what is happening</span></label>
			<input class="saito-radio" type="radio" id="dontshow" name="overlays" value="0" ${	eo ? '' : 'checked'}/>
            ...
            <input class="saito-radio" type="radio" id="confirm" name="confirm_moves" value="1" ${cm ? "checked" : ""}/>
            <label for="confirm">Confirm <span class="note">Make sure I don't accidentally misclick the board</span></label>
            <input class="saito-radio" type="radio" id="expert" name="confirm_moves" value="0" ${cm ? "": "checked"}/>
            <label for="expert">No <span class="note">I am careful</span></label>
			</fieldset>
			
			<fieldset class="saito-grid">
			<legend class="settings-label">Play Mode</legend>
            <input class="saito-radio" type="radio" id="auto" name="play_mode" value="1" ${pm ? "checked" : ""}/>
            <label for="auto">Faster <span class="note">Auto-click acknowledge after a few seconds</span></label>
            <input class="saito-radio" type="radio" id="manual" name="play_mode" value="0" ${pm ? "": "checked"}/>
