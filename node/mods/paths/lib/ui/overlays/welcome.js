...
class WelcomeOverlay {
  ...
  render(faction = '') {
    ...
    if (faction === 'central') {
      document.querySelector('.welcome-title').innerHTML = `Central Powers`;
      document.querySelector('.welcome-text').innerHTML =
        `You are playing as Germany and the Axis Powers this game.`;
    }

    if (faction === 'allies') {
      document.querySelector('.welcome-title').innerHTML = `Allied Powers`;
      document.querySelector('.welcome-text').innerHTML =
        `You are playing as Britain, France and the Allied Powers.`;
    }
