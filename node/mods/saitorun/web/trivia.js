const questions = [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answer:
          'By prioritizing transaction processing based on the importance of the transaction.',
        correct: false
      }
    ]
  },
  ...
  },
  {
    ...
    answers: [
      {
        answer:
          'users will collude with edge-nodes to monetize the existing fee, defunding network security',
        correct: true
      },
      {
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answer:
          'The miner payout is collected by the stalking table, the routing payout may happen next block',
        correct: false
      },
      {
  ...
  },
  {
    ...
    answers: [
      {
        answer:
          "because the receiving node gets less 'work' from the transaction and still has a payment obligation to the sending node",
        correct: true
      },
      {
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answer:
          'the blockchain provides free data storage, web2 firms need to pay for data storage',
        correct: false
      },
      {
