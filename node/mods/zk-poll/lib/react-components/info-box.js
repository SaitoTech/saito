  ...
  return (
    <div className="zk-info-box">
      ...
      <div className="zk-info-content">
        This polling system leverages zero-knowledge proofs (ZK-SNARKs) to ensure complete voter
        anonymity while maintaining verifiable fairness. Voters can participate without revealing
        their identity. To learn how to integrate zero-knowledge proofs with Saito, check out our{' '}
        <a href="https://wiki.saito.io/en/tech/zk-proofs" target="_blank" rel="noopener noreferrer">
