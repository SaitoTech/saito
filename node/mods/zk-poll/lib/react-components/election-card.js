      ...
      <div className="election-card">
        <div className="election-header">
          ...
          {isOwner && (
            <div className="election-actions">
              <div onClick={handleEdit} className="saito-icon-button">
                <Edit2 className="election-icon" />
              </div>
              <div onClick={() => handleDelete(election.signature)} className="saito-icon-button">
        ...
        {status === 'active' && (
          <button
            style={{
              ...style.button,
              ...(loading || selectedCandidates[election.id] === undefined
        ...
        {status === 'ended' && election.status !== 'finalized' && (
          <button style={style.button} onClick={() => onFinalize(election.signature, election.id)}>
            Finalize Results
          </button>
        )}
      </div>
