module.exports = (app, mod) => {
  ...
  let html = `
			...
			<input class="saito-radio" type="radio" id="central" name="limbo-options" value="default" ${current_source ? '' : 'checked'}/>
			<label for="central"> Defaults <span class="note">(follow Saito defaults for swarmcasting)</span></label>
			<input class="saito-radio" type="radio" id="distributed" name="limbo-options" value="advanced" ${current_source ? 'checked' : ''}/>
