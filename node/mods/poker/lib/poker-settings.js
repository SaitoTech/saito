...
class Settings {
  ...
  attachEvents() {
    ...
    Array.from(document.querySelectorAll("input[name='board']")).forEach((radio) => {
    ...
    Array.from(document.querySelectorAll("input[name='card_backs']")).forEach((radio) => {
      radio.addEventListener('change', (e) => {
    ...
    Array.from(document.querySelectorAll("input[name='table_felt']")).forEach((radio) => {
      radio.addEventListener('change', (e) => {
    ...
    if (document.getElementById('show-player-pot')) {
      document.getElementById('show-player-pot').addEventListener('change', (e) => {
