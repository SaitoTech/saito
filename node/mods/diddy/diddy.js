...
class Diddy extends ModTemplate {
  ...
  load() {
    ...
    if (this.app.options.diddy) {
      ...
      if (this.diddy.maxEnergy === undefined || isNaN(this.diddy.maxEnergy))
        this.diddy.maxEnergy = 40;
      if (this.diddy.rechargeRate === undefined || isNaN(this.diddy.rechargeRate))
        this.diddy.rechargeRate = 0.2;
      if (this.diddy.lastUpdated === undefined || isNaN(this.diddy.lastUpdated))
        this.diddy.lastUpdated = Date.now();
    } else {
