...
cycloa.NesPalette = new Uint32Array([
  0x787878, 0x2000b0, 0x2800b8, 0x6010a0, 0x982078, 0xb01030, 0xa03000, 0x784000, 0x485800,
  0x386800, 0x386c00, 0x306040, 0x305080, 0x000000, 0x000000, 0x000000, 0xb0b0b0, 0x4060f8,
  0x4040ff, 0x9040f0, 0xd840c0, 0xd84060, 0xe05000, 0xc07000, 0x888800, 0x50a000, 0x48a810,
  0x48a068, 0x4090c0, 0x000000, 0x000000, 0x000000, 0xffffff, 0x60a0ff, 0x5080ff, 0xa070ff,
  0xf060ff, 0xff60b0, 0xff7830, 0xffa000, 0xe8d020, 0x98e800, 0x70f040, 0x70e090, 0x60d0e0,
  0x787878, 0x000000, 0x000000, 0xffffff, 0x90d0ff, 0xa0b8ff, 0xc0b0ff, 0xe0b0ff, 0xffb8e8,
  0xffc8b8, 0xffd8a0, 0xfff090, 0xc8f080, 0xa0f0a0, 0xa0ffc8, 0xa0fff0, 0xa0a0a0, 0x000000, 0x000000
]);
...
cycloa.Tracer = function (machine) {
  ...
  this.addrZeropageX = function () {
    ...
    this.addr_repr_ =
      '$' + cycloa.util.formatHex(base) + ',X @ $' + cycloa.util.formatHex(this.addr_);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  this.addrZeropageY = function () {
    ...
    this.addr_repr_ =
      '$' + cycloa.util.formatHex(base) + ',Y @ $' + cycloa.util.formatHex(this.addr_);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  ...
  this.addrAbsoluteX = function () {
    ...
    this.addr_repr_ =
      '$' + cycloa.util.formatHex(base, 16) + ',X @ $' + cycloa.util.formatHex(this.addr_, 16);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  this.addrAbsoluteY = function () {
    ...
    this.addr_repr_ =
      '$' + cycloa.util.formatHex(base, 16) + ',Y @ $' + cycloa.util.formatHex(this.addr_, 16);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  this.addrIndirect = function () {
    ...
    this.addr_repr_ =
      '($' + cycloa.util.formatHex(base, 16) + ') @ $' + cycloa.util.formatHex(this.addr_, 16);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  this.addrIndirectX = function () {
    ...
    this.addr_repr_ =
      '($' + cycloa.util.formatHex(base) + ',X) @ $' + cycloa.util.formatHex(this.addr_, 16);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
  this.addrIndirectY = function () {
    ...
    this.addr_repr_ =
      '($' + cycloa.util.formatHex(base) + '),Y @ $' + cycloa.util.formatHex(this.addr_, 16);
    this.addr_resolved_repr_ = this.formatResolvedAddr_();
  };
...
cycloa.VirtualMachine = function (videoFairy, audioFairy, pad1Fairy, pad2Fairy) {
  ...
  this.__triangle__waveForm = [
    0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0xf, 0xe, 0xd,
    0xc, 0xb, 0xa, 0x9, 0x8, 0x7, 0x6, 0x5, 0x4, 0x3, 0x2, 0x1, 0x0
  ];
  ...
  while (__vm__run) {
    ...
    switch (__cpu__inst & 15) {
            ...
            if (__cpu__addr_base === 0x4015) {
              ...
              __cpu__addr =
                ...
                this.__rectangle1__frequency < 0x800
                  ? 2
                  : 0) |
                (this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0
                  ? 4
                  : 0) |
                (this.__noize__lengthCounter != 0 ? 8 : 0) |
                (this.__digital__sampleLength != 0 ? 16 : 0) |
              ...
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr_base.toString(16)
              );
            } else {
        ...
        switch ((__cpu__addr_base1 & 0xe000) >> 13) {
          ...
          case 2: {
            ...
            if (__cpu__addr_base1 === 0x4015) {
              ...
              __cpu__addr_base1 =
                (this.__pad__pad1Fairy.state >> (this.__pad__pad1Idx++ & 7)) & 0x1;
            } else if (__cpu__addr_base1 === 0x4017) {
              __cpu__addr_base1 =
                (this.__pad__pad2Fairy.state >> (this.__pad__pad2Idx++ & 7)) & 0x1;
            } else if (addr < 0x4018) {
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr_base1.toString(16)
              );
            } else {
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */
            __cpu__addr_base1 =
              __cpu__rom[(__cpu__addr_base1 >> 10) & 31][__cpu__addr_base1 & 0x3ff];
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */
        ...
        switch ((__cpu__addr_base2 & 0xe000) >> 13) {
          ...
          case 2: {
            ...
            if (__cpu__addr_base2 === 0x4015) {
              ...
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr_base2.toString(16)
              );
            } else {
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */
            __cpu__addr_base2 =
              __cpu__rom[(__cpu__addr_base2 >> 10) & 31][__cpu__addr_base2 & 0x3ff];
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */
      ...
      case 7: {
        ...
        switch ((__cpu__addr_base3 & 0xe000) >> 13) {
          ...
          case 2: {
            ...
            if (__cpu__addr_base3 === 0x4015) {
              ...
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr_base3.toString(16)
              );
            } else {
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */
            __cpu__addr_base4 =
              __cpu__rom[(__cpu__addr_base3 >> 10) & 31][__cpu__addr_base3 & 0x3ff];
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */
        ...
        var __cpu__addr_base5 =
          (__cpu__addr_base3 & 0xff00) | ((__cpu__addr_base3 + 1) & 0x00ff); /* bug of NES */
        ...
        switch ((__cpu__addr_base5 & 0xe000) >> 13) {
          ...
          case 2: {
            ...
            if (__cpu__addr_base5 === 0x4015) {
              ...
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr_base5.toString(16)
              );
            } else {
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */
            __cpu__addr_base5 =
              __cpu__rom[(__cpu__addr_base5 >> 10) & 31][__cpu__addr_base5 & 0x3ff];
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */
      ...
      case 8: {
         ...
         */
        var __cpu__addr =
          __cpu__ram[__cpu__addr_base] | (__cpu__ram[(__cpu__addr_base + 1) & 0xff] << 8);
      ...
      case 10: {
         ...
         */
        var __cpu__addr =
          (__cpu__addr_base >= 128 ? __cpu__addr_base - 256 : __cpu__addr_base) + __cpu__pc + 2;
    ...
    switch ((__cpu__inst & 65520) >> 4) {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          ...
          case 2: {
            ...
            if (__cpu__addr === 0x4015) {
              ...
              throw new cycloa.err.CoreException(
                '[FIXME] Invalid addr: 0x' + __cpu__addr.toString(16)
              );
            } else {
      ...
      case 3: {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          case 0: {
            /* 0x0000 -> 0x2000 */ __cpu__ram[__cpu__addr & 0x1fff] = this.A;
            break;
          }
          case 1: {
            /* 0x2000 -> 0x4000 */ this.__video__writeReg(__cpu__addr, this.A);
            break;
          }
          case 2: {
            /* 0x4000 -> 0x6000 */ switch (__cpu__addr & 0x1f) {
              case 0x0: {
                /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */ this.__rectangle0__decayCounter =
                  this.__rectangle0__volumeOrDecayRate = this.A & 15;
              ...
              case 0x4: {
                /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */ this.__rectangle1__decayCounter =
                  this.__rectangle1__volumeOrDecayRate = this.A & 15;
              ...
              case 0xa: {
                /* 400Ah - APU Frequency Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x0700) | this.A;
                break;
              }
              case 0xb: {
                /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x00ff) | ((this.A & 7) << 8);
              ...
              case 0xc: {
                /* 400Ch - APU Volume/Decay Channel 4 (Noise) */ this.__noize__decayCounter =
                  this.__noize__volumeOrDecayRate = this.A & 15;
              ...
              case 0xf: {
                /* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
                  this.__audio__LengthCounterConst[this.A >> 3];
              ...
              /* ------------------------------------ DMC ----------------------------------------------------- */ case 0x10: {
                ...
                this.__digital__frequency = this.__digital__FrequencyTable[this.A & 0xf];
                break;
              }
              case 0x11: {
              ...
              case 0x13: {
                /* 4013h - DMC length register */ this.__digital__sampleLength =
                  this.__digital__sampleLengthBuffer = (this.A << 4) | 1;
                break;
              }
              case 0x14: {
                ...
                for (var i = 0; i < 256; ++i) {
                  ...
                  switch ((__audio__dma__addr__ & 0xe000) >> 13) {
                    ...
                    case 2: {
                      /* 0x4000 -> 0x6000 */ if (__audio__dma__addr__ === 0x4015) {
                        ...
                        throw new cycloa.err.CoreException(
                          '[FIXME] Invalid addr: 0x' + __audio__dma__addr__.toString(16)
                        );
                      } else {
                        __audio_dma__val = this.readMapperRegisterArea(addr);
                      }
                      break;
                    }
                    case 3: {
                    ...
                    case 4: {
                      /* 0x8000 -> 0xA000 */ __audio_dma__val =
                        __cpu__rom[(__audio__dma__addr__ >> 10) & 31][__audio__dma__addr__ & 0x3ff];
                      break;
                    }
                    case 5: {
              ...
              /* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
                /* __audio__analyzeStatusRegister */ if (!(this.A & 1))
                  this.__rectangle0__lengthCounter = 0;
                if (!(this.A & 2)) this.__rectangle1__lengthCounter = 0;
                if (!(this.A & 4)) {
                  this.__triangle__lengthCounter = 0;
                  this.__triangle__linearCounter = this.__triangle__linearCounterBuffer = 0;
                }
                if (!(this.A & 8)) this.__noize__lengthCounter = 0;
                if (!(this.A & 16)) {
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */ this.writeMapperCPU(__cpu__addr, this.A);
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */ this.writeMapperCPU(__cpu__addr, this.A);
            break;
          }
          case 6: {
            /* 0xC000 -> 0xE000 */ this.writeMapperCPU(__cpu__addr, this.A);
            break;
          }
          case 7: {
            /* 0xE000 -> 0xffff */ this.writeMapperCPU(__cpu__addr, this.A);
            break;
          }
        }
        break;
      ...
      case 4: {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          case 0: {
            /* 0x0000 -> 0x2000 */ __cpu__ram[__cpu__addr & 0x1fff] = this.X;
            break;
          }
          case 1: {
            /* 0x2000 -> 0x4000 */ this.__video__writeReg(__cpu__addr, this.X);
            break;
          }
          case 2: {
            /* 0x4000 -> 0x6000 */ switch (__cpu__addr & 0x1f) {
              case 0x0: {
                /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */ this.__rectangle0__decayCounter =
                  this.__rectangle0__volumeOrDecayRate = this.X & 15;
              ...
              case 0x1: {
                /* 4001h - APU Sweep Channel 1 (Rectangle) */ this.__rectangle0__sweepShiftAmount =
                  this.X & 7;
                this.__rectangle0__sweepIncreased = (this.X & 0x8) === 0x0;
                this.__rectangle0__sweepCounter = this.__rectangle0__sweepUpdateRatio =
                  (this.X >> 4) & 3;
                this.__rectangle0__sweepEnabled = (this.X & 0x80) === 0x80;
                break;
              }
              case 0x2: {
                /* 4002h - APU Frequency Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x0700) | this.X;
                break;
              }
              case 0x3: {
                /* 4003h - APU Length Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x00ff) | ((this.X & 7) << 8);
              ...
              case 0x4: {
                /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */ this.__rectangle1__decayCounter =
                  this.__rectangle1__volumeOrDecayRate = this.X & 15;
              ...
              case 0x5: {
                /* 4005h - APU Sweep Channel 2 (Rectangle) */ this.__rectangle1__sweepShiftAmount =
                  this.X & 7;
                this.__rectangle1__sweepIncreased = (this.X & 0x8) === 0x0;
                this.__rectangle1__sweepCounter = this.__rectangle1__sweepUpdateRatio =
                  (this.X >> 4) & 3;
                this.__rectangle1__sweepEnabled = (this.X & 0x80) === 0x80;
                break;
              }
              case 0x6: {
                /* 4006h - APU Frequency Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x0700) | this.X;
                break;
              }
              case 0x7: {
                /* 4007h - APU Length Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x00ff) | ((this.X & 7) << 8);
              ...
              case 0xa: {
                /* 400Ah - APU Frequency Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x0700) | this.X;
                break;
              }
              case 0xb: {
                /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x00ff) | ((this.X & 7) << 8);
              ...
              case 0xc: {
                /* 400Ch - APU Volume/Decay Channel 4 (Noise) */ this.__noize__decayCounter =
                  this.__noize__volumeOrDecayRate = this.X & 15;
              ...
              case 0xf: {
                /* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
                  this.__audio__LengthCounterConst[this.X >> 3];
                /* and restarts the decay volume (channel 1,2,4 only). */ this.__noize__decayReloaded = true;
                break;
              }
              /* ------------------------------------ DMC ----------------------------------------------------- */ case 0x10: {
                ...
                this.__digital__frequency = this.__digital__FrequencyTable[this.X & 0xf];
                break;
              }
              case 0x11: {
                /* 4011h - DMC Delta counter load register */ this.__digital__deltaCounter =
              ...
              case 0x13: {
                /* 4013h - DMC length register */ this.__digital__sampleLength =
                  this.__digital__sampleLengthBuffer = (this.X << 4) | 1;
                break;
              }
              case 0x14: {
                /* 4014h execute Sprite DMA */ /** @type {number} uint16_t */ var __audio__dma__addrMask =
              ...
              /* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
                /* __audio__analyzeStatusRegister */ if (!(this.X & 1))
                  this.__rectangle0__lengthCounter = 0;
                if (!(this.X & 2)) this.__rectangle1__lengthCounter = 0;
                if (!(this.X & 4)) {
                  this.__triangle__lengthCounter = 0;
                  this.__triangle__linearCounter = this.__triangle__linearCounterBuffer = 0;
                }
                if (!(this.X & 8)) this.__noize__lengthCounter = 0;
                if (!(this.X & 16)) {
                  this.__digital__sampleLength = 0;
                } else if (this.__digital__sampleLength == 0) {
                  this.__digital__sampleLength = this.__digital__sampleLengthBuffer;
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */ this.writeMapperCPU(__cpu__addr, this.X);
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */ this.writeMapperCPU(__cpu__addr, this.X);
            break;
          }
          case 6: {
            /* 0xC000 -> 0xE000 */ this.writeMapperCPU(__cpu__addr, this.X);
            break;
          }
          case 7: {
            /* 0xE000 -> 0xffff */ this.writeMapperCPU(__cpu__addr, this.X);
            break;
          }
        }
        break;
      ...
      case 5: {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          case 0: {
            /* 0x0000 -> 0x2000 */ __cpu__ram[__cpu__addr & 0x1fff] = this.Y;
            break;
          }
          case 1: {
            /* 0x2000 -> 0x4000 */ this.__video__writeReg(__cpu__addr, this.Y);
            break;
          }
          case 2: {
            /* 0x4000 -> 0x6000 */ switch (__cpu__addr & 0x1f) {
              case 0x0: {
                /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */ this.__rectangle0__decayCounter =
                  this.__rectangle0__volumeOrDecayRate = this.Y & 15;
              ...
              case 0x1: {
                /* 4001h - APU Sweep Channel 1 (Rectangle) */ this.__rectangle0__sweepShiftAmount =
                  this.Y & 7;
                this.__rectangle0__sweepIncreased = (this.Y & 0x8) === 0x0;
                this.__rectangle0__sweepCounter = this.__rectangle0__sweepUpdateRatio =
                  (this.Y >> 4) & 3;
                this.__rectangle0__sweepEnabled = (this.Y & 0x80) === 0x80;
                break;
              }
              case 0x2: {
                /* 4002h - APU Frequency Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x0700) | this.Y;
                break;
              }
              case 0x3: {
                /* 4003h - APU Length Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x00ff) | ((this.Y & 7) << 8);
              ...
              case 0x4: {
                /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */ this.__rectangle1__decayCounter =
                  this.__rectangle1__volumeOrDecayRate = this.Y & 15;
              ...
              case 0x5: {
                /* 4005h - APU Sweep Channel 2 (Rectangle) */ this.__rectangle1__sweepShiftAmount =
                  this.Y & 7;
                this.__rectangle1__sweepIncreased = (this.Y & 0x8) === 0x0;
                this.__rectangle1__sweepCounter = this.__rectangle1__sweepUpdateRatio =
                  (this.Y >> 4) & 3;
                this.__rectangle1__sweepEnabled = (this.Y & 0x80) === 0x80;
                break;
              }
              case 0x6: {
                /* 4006h - APU Frequency Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x0700) | this.Y;
                break;
              }
              case 0x7: {
                /* 4007h - APU Length Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x00ff) | ((this.Y & 7) << 8);
              ...
              case 0xa: {
                /* 400Ah - APU Frequency Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x0700) | this.Y;
                break;
              }
              case 0xb: {
                /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x00ff) | ((this.Y & 7) << 8);
              ...
              case 0xc: {
                /* 400Ch - APU Volume/Decay Channel 4 (Noise) */ this.__noize__decayCounter =
                  this.__noize__volumeOrDecayRate = this.Y & 15;
              ...
              case 0xf: {
                /* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
                  this.__audio__LengthCounterConst[this.Y >> 3];
                /* and restarts the decay volume (channel 1,2,4 only). */ this.__noize__decayReloaded = true;
                break;
              }
              /* ------------------------------------ DMC ----------------------------------------------------- */ case 0x10: {
                ...
                this.__digital__frequency = this.__digital__FrequencyTable[this.Y & 0xf];
                break;
              }
              case 0x11: {
                /* 4011h - DMC Delta counter load register */ this.__digital__deltaCounter =
              ...
              case 0x13: {
                /* 4013h - DMC length register */ this.__digital__sampleLength =
                  this.__digital__sampleLengthBuffer = (this.Y << 4) | 1;
                break;
              }
              case 0x14: {
                /* 4014h execute Sprite DMA */ /** @type {number} uint16_t */ var __audio__dma__addrMask =
              ...
              /* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
                /* __audio__analyzeStatusRegister */ if (!(this.Y & 1))
                  this.__rectangle0__lengthCounter = 0;
                if (!(this.Y & 2)) this.__rectangle1__lengthCounter = 0;
                if (!(this.Y & 4)) {
                  this.__triangle__lengthCounter = 0;
                  this.__triangle__linearCounter = this.__triangle__linearCounterBuffer = 0;
                }
                if (!(this.Y & 8)) this.__noize__lengthCounter = 0;
                if (!(this.Y & 16)) {
                  this.__digital__sampleLength = 0;
                } else if (this.__digital__sampleLength == 0) {
                  this.__digital__sampleLength = this.__digital__sampleLengthBuffer;
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */ this.writeMapperCPU(__cpu__addr, this.Y);
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */ this.writeMapperCPU(__cpu__addr, this.Y);
            break;
          }
          case 6: {
            /* 0xC000 -> 0xE000 */ this.writeMapperCPU(__cpu__addr, this.Y);
            break;
          }
          case 7: {
            /* 0xE000 -> 0xffff */ this.writeMapperCPU(__cpu__addr, this.Y);
            break;
          }
        }
        break;
      ...
      case 6: {
        /* TAX */
        /* UpdateFlag */ this.P = (this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = this.A)];
        break;
      }
      case 7: {
        /* TAY */
        /* UpdateFlag */ this.P = (this.P & 0x7d) | __cpu__ZNFlagCache[(this.Y = this.A)];
        break;
      }
      case 8: {
        /* TSX */
        /* UpdateFlag */ this.P = (this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = this.SP)];
        break;
      }
      case 9: {
        /* TXA */
        /* UpdateFlag */ this.P = (this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = this.X)];
        break;
      }
      case 10: {
        /* TXS */
      ...
      case 11: {
        /* TYA */
        /* UpdateFlag */ this.P = (this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = this.Y)];
        break;
      }
      case 12: {
        /* ADC */
        ...
        this.P =
          (__cpu__adc_p & 0xbe) |
          (((((__cpu__adc_a ^ val) & 0x80) ^ 0x80) & ((__cpu__adc_a ^ __cpu__adc_newA) & 0x80)) >>
      ...
      case 14: {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          case 0: {
            /* 0x0000 -> 0x2000 */ __cpu__ram[__cpu__addr & 0x1fff] = shifted;
            break;
          }
          case 1: {
            /* 0x2000 -> 0x4000 */ this.__video__writeReg(__cpu__addr, shifted);
            break;
          }
          case 2: {
            /* 0x4000 -> 0x6000 */ switch (__cpu__addr & 0x1f) {
              case 0x0: {
                /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */ this.__rectangle0__decayCounter =
                  this.__rectangle0__volumeOrDecayRate = shifted & 15;
                this.__rectangle0__decayEnabled = (shifted & 16) == 0;
                this.__rectangle0__loopEnabled = (shifted & 32) == 32;
                switch (shifted >> 6) {
                  case 0:
                    this.__rectangle0__dutyRatio = 2;
                    break;
              ...
              case 0x1: {
                /* 4001h - APU Sweep Channel 1 (Rectangle) */ this.__rectangle0__sweepShiftAmount =
                  shifted & 7;
                this.__rectangle0__sweepIncreased = (shifted & 0x8) === 0x0;
                this.__rectangle0__sweepCounter = this.__rectangle0__sweepUpdateRatio =
                  (shifted >> 4) & 3;
                this.__rectangle0__sweepEnabled = (shifted & 0x80) === 0x80;
                break;
              }
              case 0x2: {
                /* 4002h - APU Frequency Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x0700) | shifted;
                break;
              }
              case 0x3: {
                /* 4003h - APU Length Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x00ff) | ((shifted & 7) << 8);
                this.__rectangle0__lengthCounter = this.__audio__LengthCounterConst[shifted >> 3];
                /* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */ this.__rectangle0__dutyCounter = 0;
                /* and restarts the decay volume (channel 1,2,4 only). */ this.__rectangle0__decayReloaded = true;
                break;
              }
              case 0x4: {
                /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */ this.__rectangle1__decayCounter =
                  this.__rectangle1__volumeOrDecayRate = shifted & 15;
                this.__rectangle1__decayEnabled = (shifted & 16) == 0;
                this.__rectangle1__loopEnabled = (shifted & 32) == 32;
                switch (shifted >> 6) {
                  case 0:
                    this.__rectangle1__dutyRatio = 2;
                    break;
              ...
              case 0x5: {
                /* 4005h - APU Sweep Channel 2 (Rectangle) */ this.__rectangle1__sweepShiftAmount =
                  shifted & 7;
                this.__rectangle1__sweepIncreased = (shifted & 0x8) === 0x0;
                this.__rectangle1__sweepCounter = this.__rectangle1__sweepUpdateRatio =
                  (shifted >> 4) & 3;
                this.__rectangle1__sweepEnabled = (shifted & 0x80) === 0x80;
                break;
              }
              case 0x6: {
                /* 4006h - APU Frequency Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x0700) | shifted;
                break;
              }
              case 0x7: {
                /* 4007h - APU Length Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x00ff) | ((shifted & 7) << 8);
                this.__rectangle1__lengthCounter = this.__audio__LengthCounterConst[shifted >> 3];
                /* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */ this.__rectangle1__dutyCounter = 0;
                /* and restarts the decay volume (channel 1,2,4 only). */ this.__rectangle1__decayReloaded = true;
                break;
              }
              case 0x8: {
                /* 4008h - APU Linear Counter Channel 3 (Triangle) */ this.__triangle__enableLinearCounter =
                  (shifted & 128) == 128;
                this.__triangle__linearCounterBuffer = shifted & 127;
                break;
              }
              case 0x9: {
                /* 4009h - APU N/A Channel 3 (Triangle) */ /* unused */ break;
              ...
              case 0xa: {
                /* 400Ah - APU Frequency Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x0700) | shifted;
                break;
              }
              case 0xb: {
                /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x00ff) | ((shifted & 7) << 8);
                this.__triangle__lengthCounter = this.__audio__LengthCounterConst[shifted >> 3];
                /* Side effects 	Sets the halt flag */ this.__triangle__haltFlag = true;
                break;
              }
              case 0xc: {
                /* 400Ch - APU Volume/Decay Channel 4 (Noise) */ this.__noize__decayCounter =
                  this.__noize__volumeOrDecayRate = shifted & 15;
                this.__noize__decayEnabled = (shifted & 16) == 0;
                this.__noize__loopEnabled = (shifted & 32) == 32;
                break;
              }
              case 0xd: {
                /* 400Dh - APU N/A Channel 4 (Noise) */ /* unused */ break;
              ...
              case 0xe: {
                /* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag =
                  (shifted & 128) == 128;
                this.__noize__frequency = this.__noize__FrequencyTable[shifted & 15];
                break;
              }
              case 0xf: {
                /* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
                  this.__audio__LengthCounterConst[shifted >> 3];
                /* and restarts the decay volume (channel 1,2,4 only). */ this.__noize__decayReloaded = true;
                break;
              }
              /* ------------------------------------ DMC ----------------------------------------------------- */ case 0x10: {
                ...
                this.__digital__loopEnabled = (shifted & 64) == 64;
                this.__digital__frequency = this.__digital__FrequencyTable[shifted & 0xf];
                break;
              }
              case 0x11: {
                /* 4011h - DMC Delta counter load register */ this.__digital__deltaCounter =
              ...
              case 0x13: {
                /* 4013h - DMC length register */ this.__digital__sampleLength =
                  this.__digital__sampleLengthBuffer = (shifted << 4) | 1;
                break;
              }
              case 0x14: {
                /* 4014h execute Sprite DMA */ /** @type {number} uint16_t */ var __audio__dma__addrMask =
              ...
              /* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
                /* __audio__analyzeStatusRegister */ if (!(shifted & 1))
                  this.__rectangle0__lengthCounter = 0;
                if (!(shifted & 2)) this.__rectangle1__lengthCounter = 0;
                if (!(shifted & 4)) {
                  this.__triangle__lengthCounter = 0;
                  this.__triangle__linearCounter = this.__triangle__linearCounterBuffer = 0;
                }
                if (!(shifted & 8)) this.__noize__lengthCounter = 0;
                if (!(shifted & 16)) {
                  this.__digital__sampleLength = 0;
                } else if (this.__digital__sampleLength == 0) {
                  this.__digital__sampleLength = this.__digital__sampleLengthBuffer;
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */ this.writeMapperCPU(__cpu__addr, shifted);
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */ this.writeMapperCPU(__cpu__addr, shifted);
            break;
          }
          case 6: {
            /* 0xC000 -> 0xE000 */ this.writeMapperCPU(__cpu__addr, shifted);
            break;
          }
          case 7: {
            /* 0xE000 -> 0xffff */ this.writeMapperCPU(__cpu__addr, shifted);
            break;
          }
        }
      ...
      case 16: {
        ...
        this.P = (this.P & 0x3d) | (val & 0xc0) | (__cpu__ZNFlagCache[this.A & val] & 0x2);
        break;
      }
      case 17: {
        /* CMP */
      ...
      case 20: {
        ...
        switch ((__cpu__addr & 0xe000) >> 13) {
          case 0: {
            /* 0x0000 -> 0x2000 */ __cpu__ram[__cpu__addr & 0x1fff] = val;
            break;
          }
          case 1: {
            /* 0x2000 -> 0x4000 */ this.__video__writeReg(__cpu__addr, val);
            break;
          }
          case 2: {
            /* 0x4000 -> 0x6000 */ switch (__cpu__addr & 0x1f) {
              ...
              case 0x3: {
                /* 4003h - APU Length Channel 1 (Rectangle) */ this.__rectangle0__frequency =
                  (this.__rectangle0__frequency & 0x00ff) | ((val & 7) << 8);
              ...
              case 0x7: {
                /* 4007h - APU Length Channel 2 (Rectangle) */ this.__rectangle1__frequency =
                  (this.__rectangle1__frequency & 0x00ff) | ((val & 7) << 8);
              ...
              case 0xb: {
                /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
                  (this.__triangle__frequency & 0x00ff) | ((val & 7) << 8);
          ...
          case 4: {
            /* 0x8000 -> 0xA000 */ this.writeMapperCPU(__cpu__addr, val);
            break;
          }
          case 5: {
            /* 0xA000 -> 0xC000 */ this.writeMapperCPU(__cpu__addr, val);
            break;
          }
          case 6: {
            /* 0xC000 -> 0xE000 */ this.writeMapperCPU(__cpu__addr, val);
            break;
          }
          case 7: {
            /* 0xE000 -> 0xffff */ this.writeMapperCPU(__cpu__addr, val);
            break;
          }
        }
        break;
      ...
      case 21: {
        /* DEX */
        /* UpdateFlag */ this.P =
          (this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = (this.X - 1) & 0xff)];
        break;
      }
      case 22: {
        /* DEY */
        /* UpdateFlag */ this.P =
          (this.P & 0x7d) | __cpu__ZNFlagCache[(this.Y = (this.Y - 1) & 0xff)];
        break;
      }
      case 23: {
        /* EOR */
      ...
      case 31: {
        ...
        /* UpdateFlag */ this.P =
          (this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = (a << 1) | (p & 0x01))];
        break;
      }
      case 32: {
        /* ROR */
      ...
      case 33: {
        ...
        /* UpdateFlag */ this.P =
          (this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = ((a >> 1) & 0x7f) | ((p & 0x1) << 7))];
        break;
      }
      case 34: {
        /* SBC */
        ...
        var __cpu__sbc_result =
          (__cpu__sbc_a - __cpu__sbc_val - ((__cpu__sbc_p & 0x1) ^ 0x1)) & 0xffff;
        /**
         * @type {number}
         */
      ...
      case 35: {
        /* PHA */
        /* ::CPU::Push */ __cpu__ram[0x0100 | (this.SP-- & 0xff)] = this.A;
        break;
      }
      case 36: {
        /* PHP */
      ...
      case 37: {
        ...
        /* UpdateFlag */ this.P =
          (this.P & 0x7d) |
          __cpu__ZNFlagCache[(this.A = /* ::CPU::Pop */ __cpu__ram[0x0100 | (++this.SP & 0xff)])];
        break;
      }
      case 38: {
        /* PLP */
      ...
      case 48: {
        ...
        this.PC =
          /* ::CPU::Pop */ (__cpu__ram[0x0100 | (++this.SP & 0xff)] |
            /* ::CPU::Pop */ (__cpu__ram[0x0100 | (++this.SP & 0xff)] << 8)) +
          1;
        break;
      }
      case 49: {
              ...
              if (this.__rectangle1__sweepCounter == 0) {
                ...
                if (
                  ...
                  var __rectangle1__shift =
                    this.__rectangle1__frequency >> this.__rectangle1__sweepShiftAmount;
              ...
              if (this.__rectangle0__sweepCounter == 0) {
                ...
                if (
                  ...
                  var __rectangle0__shift =
                    this.__rectangle0__frequency >> this.__rectangle0__sweepShiftAmount;
    ...
    while (this.__audio__clockCnt >= 1786840) {
        ...
        __audio__sound +=
          this.__triangle__waveForm[
            (this.__triangle__streamCounter =
              (this.__triangle__streamCounter + __triangle__nowCounter / __triangle__freq) & 31)
          ];
      }
      ...
      if (this.__noize__lengthCounter != 0) {
        ...
        while (__noize__nowCounter >= __noize__divFreq) {
          ...
          __noize__shiftReg =
            (__noize__shiftReg >> 1) |
            (((__noize__shiftReg ^ (__noize__shiftReg >> __noize__shiftAmount)) & 1) << 14);
        }
            ...
            switch ((__digital__addr & 0xe000) >> 13) {
              ...
              case 2: {
			   ...
			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
                  ...
                  throw new cycloa.err.CoreException(
                    '[FIXME] Invalid addr: 0x' + __digital__addr.toString(16)
                  );
                } else {
  ...
  switch ((addr & 0xe000) >> 13) {
    ...
    case 2: {
      /* 0x4000 -> 0x6000 */ switch (addr & 0x1f) {
        ...
        case 0xe: {
          /* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag = (val & 128) == 128;
          this.__noize__frequency = this.__noize__FrequencyTable[val & 15];
          break;
        }
        case 0xf: {
        ...
        case 0x11: {
          /* 4011h - DMC Delta counter load register */ this.__digital__deltaCounter = val & 0x7f;
          break;
        }
        case 0x12: {
          /* 4012h - DMC address load register */ this.__digital__sampleAddr = 0xc000 | (val << 6);
          break;
        }
        case 0x13: {
          /* 4013h - DMC length register */ this.__digital__sampleLength =
        ...
        case 0x14: {
          ...
          for (var i = 0; i < 256; ++i) {
            ...
            switch ((__audio__dma__addr__ & 0xe000) >> 13) {
              case 0: {
                /* 0x0000 -> 0x2000 */ __audio_dma__val = __cpu__ram[__audio__dma__addr__ & 0x7ff];
                break;
              }
              case 1: {
                /* 0x2000 -> 0x4000 */ __audio_dma__val =
        ...
        /* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
          /* __audio__analyzeStatusRegister */ if (!(val & 1)) this.__rectangle0__lengthCounter = 0;
          if (!(val & 2)) this.__rectangle1__lengthCounter = 0;
          if (!(val & 4)) {
            this.__triangle__lengthCounter = 0;
            this.__triangle__linearCounter = this.__triangle__linearCounterBuffer = 0;
    ...
    case 2: {
      /* 0x4000 -> 0x6000 */ switch (0x4017 & 0x1f) {
        ...
        case 0x1: {
          ...
          this.__rectangle0__sweepCounter = this.__rectangle0__sweepUpdateRatio = (0x00 >> 4) & 3;
        ...
        case 0x3: {
          /* 4003h - APU Length Channel 1 (Rectangle) */ this.__rectangle0__frequency =
            (this.__rectangle0__frequency & 0x00ff) | ((0x00 & 7) << 8);
          this.__rectangle0__lengthCounter = this.__audio__LengthCounterConst[0x00 >> 3];
          /* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */ this.__rectangle0__dutyCounter = 0;
          /* and restarts the decay volume (channel 1,2,4 only). */ this.__rectangle0__decayReloaded = true;
          break;
        }
        ...
        case 0x5: {
          ...
          this.__rectangle1__sweepCounter = this.__rectangle1__sweepUpdateRatio = (0x00 >> 4) & 3;
        ...
        case 0x7: {
          /* 4007h - APU Length Channel 2 (Rectangle) */ this.__rectangle1__frequency =
            (this.__rectangle1__frequency & 0x00ff) | ((0x00 & 7) << 8);
          this.__rectangle1__lengthCounter = this.__audio__LengthCounterConst[0x00 >> 3];
          /* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */ this.__rectangle1__dutyCounter = 0;
          /* and restarts the decay volume (channel 1,2,4 only). */ this.__rectangle1__decayReloaded = true;
          break;
        }
        ...
        case 0xb: {
          /* 400Bh - APU Length Channel 3 (Triangle) */ this.__triangle__frequency =
            (this.__triangle__frequency & 0x00ff) | ((0x00 & 7) << 8);
          this.__triangle__lengthCounter = this.__audio__LengthCounterConst[0x00 >> 3];
          /* Side effects 	Sets the halt flag */ this.__triangle__haltFlag = true;
          break;
        }
        case 0xc: {
        ...
        case 0xe: {
          /* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag =
            (0x00 & 128) == 128;
          this.__noize__frequency = this.__noize__FrequencyTable[0x00 & 15];
          break;
        }
        case 0xf: {
          /* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
        ...
        /* ------------------------------------ DMC ----------------------------------------------------- */ case 0x10: {
          ...
          this.__digital__frequency = this.__digital__FrequencyTable[0x00 & 0xf];
          break;
        }
        case 0x11: {
          /* 4011h - DMC Delta counter load register */ this.__digital__deltaCounter = 0x00 & 0x7f;
          break;
        }
        case 0x12: {
          /* 4012h - DMC address load register */ this.__digital__sampleAddr = 0xc000 | (0x00 << 6);
          break;
        }
        case 0x13: {
          /* 4013h - DMC length register */ this.__digital__sampleLength =
...
cycloa.VirtualMachine.TransTable = new Uint32Array([
  459499, 393688, 255, 255, 255, 197073, 327905, 255, 197195, 131536, 131323, 255, 255, 262612,
  393444, 255, 131994, 328153, 255, 255, 255, 262610, 393442, 255, 131707, 262614, 255, 255, 255,
  262613, 393445, 255, 394036, 393432, 255, 255, 196865, 196817, 328161, 255, 262763, 131280,
  131579, 255, 262404, 262356, 393700, 255, 131962, 327897, 255, 255, 255, 262354, 393698, 255,
  131771, 262358, 255, 255, 255, 262357, 393701, 255, 394011, 393592, 255, 255, 255, 196977, 328113,
  255, 197179, 131440, 131531, 255, 197412, 262516, 393652, 255, 132010, 328057, 255, 255, 255,
  262514, 393650, 255, 131739, 262518, 255, 255, 255, 262517, 393653, 255, 393995, 393416, 255, 255,
  255, 196801, 328193, 255, 262747, 131264, 131611, 255, 328487, 262340, 393732, 255, 132026,
  327881, 255, 255, 255, 262338, 393730, 255, 131803, 262342, 255, 255, 255, 262341, 393733, 255,
  255, 393272, 255, 255, 196689, 196657, 196673, 255, 131435, 255, 131227, 255, 262228, 262196,
  262212, 255, 131914, 327737, 255, 255, 262226, 262194, 262211, 255, 131259, 262198, 131243, 255,
  255, 262197, 255, 255, 131104, 393224, 131088, 255, 196641, 196609, 196625, 255, 131195, 131072,
  131179, 255, 262180, 262148, 262164, 255, 131930, 327689, 255, 255, 262178, 262146, 262163, 255,
  131755, 262150, 131211, 255, 262181, 262149, 262166, 255, 131376, 393496, 255, 255, 196913,
  196881, 328001, 255, 131499, 131344, 131419, 255, 262452, 262420, 393540, 255, 131978, 327961,
  255, 255, 255, 262418, 393538, 255, 131723, 262422, 255, 255, 255, 262421, 393541, 255, 131360,
  393768, 255, 255, 196897, 197153, 328065, 255, 131483, 131616, 131835, 255, 262436, 262692,
  393604, 255, 131946, 328233, 255, 255, 255, 262690, 393602, 255, 131787, 262694, 255, 255, 255,
  262693, 393605, 255
]);
...
cycloa.VirtualMachine.prototype.__video__buildBgLine = function () {
  ...
  while (true) {
    ...
    var tileNo =
      (nameTableAddr & 0x3f00) !== 0x3f00
        ? nameTableAddr < 0x2000
          ? __video__pattern[(nameTableAddr >> 9) & 0xf][nameTableAddr & 0x1ff]
          : __video__vramMirroring[(nameTableAddr >> 10) & 0x3][nameTableAddr & 0x3ff]
        : nameTableAddr & (0x3 === 0)
     ...
     */
    var palAddr =
      (nameTableAddr & 0x2f00) | 0x3c0 | ((tileYofScreen & 0x1c) << 1) | ((nameTableAddr >> 2) & 7);
    /**
     * @type {number} uint8_t
     * @const
     */
    var palNo =
      (((palAddr & 0x3f00) !== 0x3f00
        ? palAddr < 0x2000
          ...
          : __video__vramMirroring[(palAddr >> 10) & 0x3][palAddr & 0x3ff]
        : palAddr & (0x3 === 0)
          ? __video__palette[32 | ((addr >> 2) & 3)]
    ...
    var secondPlane =
      (secondPlaneAddr & 0x3f00) !== 0x3f00
        ? secondPlaneAddr < 0x2000
          ? __video__pattern[(secondPlaneAddr >> 9) & 0xf][secondPlaneAddr & 0x1ff]
          : __video__vramMirroring[(secondPlaneAddr >> 10) & 0x3][secondPlaneAddr & 0x3ff]
  ...
  for (var i = 0; i < _spriteHitCnt; i++) {
    ...
    if (slot.flipHorizontal) {
      for (var x = 0; x < endX; x++) {
        ...
        if (
          color != 0 &&
          ((!slot.isForeground && isEmpty) || (slot.isForeground && isSpriteNotDrawn))
        ) {
          __video__screenBuffer8[buffOffset + slot.x + x] =
            __video__palette[(slot.paletteNo << 2) + color] | layerMask;
        }
      }
    } else {
      for (var x = 0; x < endX; x++) {
  ...
  switch (addr & 0x07) {
    ...
    case 0x00: {
      ...
      this.__video__vramAddrReloadRegister =
        (this.__video__vramAddrReloadRegister & 0x73ff) | ((value & 0x3) << 10);
      break;
    }
    case 0x01: {
    ...
    case 0x05: {
      ...
      if (this.__video__scrollRegisterWritten) {
        ...
        //X
        this.__video__vramAddrReloadRegister =
          (this.__video__vramAddrReloadRegister & 0xffe0) | (value >> 3);
    ...
    case 0x06: {
      ...
      if (this.__video__vramAddrRegisterWritten) {
        ...
        this.__video__vramAddrReloadRegister =
          (this.__video__vramAddrReloadRegister & 0x00ff) | ((value & 0x7f) << 8);
      }
    ...
    case 0x07: {
      ...
      this.__video__vramAddrRegister =
        (this.__video__vramAddrRegister + this.__video__vramIncrementSize) & 0x3fff;
      break;
    }
    default: {
      ...
      if ((vramAddrRegister & 0x3f00) !== 0x3f00) {
        ...
        this.__video__vramBuffer =
          vramAddrRegister < 0x2000
            ? __video__pattern[(vramAddrRegister >> 9) & 0xf][vramAddrRegister & 0x1ff]
            : __video__vramMirroring[(vramAddrRegister >> 10) & 0x3][vramAddrRegister & 0x3ff];
        this.__video__vramAddrRegister =
          (vramAddrRegister + this.__video__vramIncrementSize) & 0x3fff;
        return ret;
      } else {
        /**
         * @type {number} uint8_t */
        ...
        this.__video__vramBuffer =
          vramAddrRegister < 0x2000
            ? __video__pattern[(vramAddrRegister >> 9) & 0xf][vramAddrRegister & 0x1ff]
            : __video__vramMirroring[(vramAddrRegister >> 10) & 0x3][vramAddrRegister & 0x3ff]; //ミラーされてるVRAMにも同時にアクセスしなければならない。
        this.__video__vramAddrRegister =
          (vramAddrRegister + this.__video__vramIncrementSize) & 0x3fff;
        return ret;
      }
