  ...
  (function (window, undefined) {
        ...
        while (soFar) {
          ...
          for (type in filters) {
            if (
              ...
              (!preFilters[type] || (match = preFilters[type](match, context, xml)))
            ) {
    ...
    var select = function (selector, context, results, seed, xml) {
      ...
      if (seed) {
        ...
        findContext =
          ((match = rsibling.exec(tokens[0])) && !match.index && context.parentNode) || context;
            ...
            if (context.nodeType === 9) {
              ...
              try {
                push.apply(
                  results,
                  slice.call(
                    newContext.querySelectorAll(selector.replace(rgroups, "[id='" + nid + "'] $&")),
                    0
                  )
                );
                return results;
