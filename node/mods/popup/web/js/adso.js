      ...
      function (txt2) {
        ...
        try {
          ...
          if (mnew_field6 == document.getElementById('row_6').innerHTML) {
            row_1 = mnew_field3;
            document.getElementById('row_1').innerHTML = mnew_field3;
            row_2 = mnew_field4;
            document.getElementById('row_2').innerHTML = mnew_field4;
            row_3 = mnew_field2;
            document.getElementById('row_3').innerHTML = mnew_field2;
          }
        } catch (err) {}
        ...
        replace_string =
          "'" + mnew_field2 + "','" + mnew_field3 + "','" + mnew_field4 + "','" + mnew_field5 + "'";
        re = new RegExp(original_string, 'g');
        temp = temp.replace(re, replace_string);
        object_under_updating.innerHTML = temp;
      }
