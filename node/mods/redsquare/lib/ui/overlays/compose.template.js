...
module.exports = (compose) => {
  ...
  return `
    <div class="compose ${mode}" id="${compose.overlay_id}" aria-label="${ariaLabel}">
      <div class="dialog saito-overlay-panel">
        <div class="body">
          ${replyPreview}
          ...
          <div class="composer">
            ...
            <div class="main">
              ...
              <div class="surface" id="redsquare-compose-surface">
                ...
                <div
                  class="compose-picker emoji-picker-panel saito-overlay-panel compact"
                  aria-hidden="true"
                >
                ...
                <div
                  class="compose-picker gif-picker-panel saito-overlay-panel compact"
                  aria-hidden="true"
                >
                  <div class="compose-picker-header">
