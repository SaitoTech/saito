    ...
    <div class="stack-splash">
      <section class="stack-cta-section">
        ...
        <div class="stack-cta-content">
          <h2 class="stack-cta-title">Publishing without Publishers</h2>
          <p class="stack-cta-description">
            Create a subscription-based blog, distribute NFTs for access, and build your own audience on your own terms.
          </p>
