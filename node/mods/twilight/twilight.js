...
// Card modules
const TwilightCardsCore = require('./lib/cards-core');
const TwilightCardsSaito = require('./lib/cards-saito');
const TwilightCardsCommunity = require('./lib/cards-community');
const TwilightCardsEndOfHistory = require('./lib/cards-endofhistory');
const TwilightCardsColdWarCrazies = require('./lib/cards-coldwarcrazies');
...
Twilight.importFunctions(
  TwilightCardsCore,
  TwilightCardsSaito,
  TwilightCardsCommunity,
  TwilightCardsEndOfHistory,
  TwilightCardsColdWarCrazies
);
