...
class OnboardingOverlay {
  ...
  showStep(step) {
    ...
    switch (step) {
      case 'splash':
        html = OnboardingSplashTemplate();
        break;
      case 'create-choice':
        html = OnboardingCreateChoiceTemplate();
        break;
      case 'create-templates':
        html = OnboardingTemplatePickerTemplate(this.templates);
        break;
      case 'interact':
        html = OnboardingInteractTemplate();
        break;
      default:
        html = OnboardingSplashTemplate();
    }
...
OnboardingOverlay.shouldShow = function shouldShow(app) {
...
module.exports = OnboardingOverlay;
