module.exports = (app, mod) => {
  ...
  return `
			...
			<input class="saito-radio" type="radio" id="easy" name="spider-difficulty" value="easy" ${difficulty == 'easy' ? 'checked' : ''}/>
			<label for="easy">Easy <span class="note">1 suit</span></label>
			<input class="saito-radio" type="radio" id="medium" name="spider-difficulty" value="medium" ${difficulty == 'medium' ? 'checked' : ''}/>
			<label for="medium">Medium <span class="note">2 suits</span></label>
			<input class="saito-radio" type="radio" id="hard" name="spider-difficulty" value="hard" ${difficulty == 'hard' ? 'checked' : ''}/>
