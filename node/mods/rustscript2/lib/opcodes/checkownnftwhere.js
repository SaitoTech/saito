...
`,
  ...
  execute(node, context) {
    ...
    let utxo1 = lookupField(node, 'utxokey1');
    let utxo2 = lookupField(node, 'utxokey2');
    let utxo3 = lookupField(node, 'utxokey3');

    if (isUnsetFieldValue(utxo1) || isUnsetFieldValue(utxo2) || isUnsetFieldValue(utxo3)) {
      return false;
    }
