module.exports = (app, mod, build_number, og_card) => {
  ...
  <head>
    ...
    <meta name="application-name" content="Saito Docs" />
    <meta name="apple-mobile-web-app-title" content="Saito Docs" />
    ...
    <script data-pace-options='{ "restartOnRequestAfter": false, "restartOnPushState": false }'
      src="/saito/lib/pace/pace.min.js"></script>
