  ...
  let html = `
    <div id="yt-stream" class="yt-stream">
			...
			<div class="yt-stream-type">
				<input class="saito-radio" type="radio" name="stream_type" value="main" checked>
				<div class="yt-stream-type-name">Main stream</div>
				<input class="saito-radio" type="radio" name="stream_type" value="backup">
				<div class="yt-stream-type-name">Backup stream</div>
			</div>
			-->

			<div id="yt-stream-btn" class="saito-button-primary">Go Live</div>
		</div>
  `;
