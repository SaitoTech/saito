...
const TutorialTemplate = require('./../overlays/tutorials/tutorial.template');
	...
	attachEvents(targs={}, t=null) {
	  ...
	  gh.onclick = (e) => {
	    if (t != null) {
	      ...
	      this.overlay.show(TutorialTemplate(targs)); 
	    }
	    this.toggle();
	  }
