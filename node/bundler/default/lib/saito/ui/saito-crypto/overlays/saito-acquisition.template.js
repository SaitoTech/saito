module.exports = () => {
  return `
        ...
        <div>While most tokens in circulation exist on that main network, approximately 30 percent of Saito tokens started circulating in the form of ERC20 / BEP20 tokens. You can aquire those on the exchange of your choice, e.g. GateIO, Latoken, Bitrue, Uniswap, PancakeSwap, or Dexpro.</div>
        <div>If you are holding ERC20 Saito tokens, we have a <a href="/migration"> migration service</a> to bridge them onto the network.</div>
        <div>See the <a href="https://wiki.saito.io/en/tokenomics">Tokenomics</a> Wiki page for more information.</div>
        </div>
    `;
};
